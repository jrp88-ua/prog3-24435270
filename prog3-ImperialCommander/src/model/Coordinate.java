...
public class Coordinate {
	 ...
	 * 
	 * @return True if {@code this == other} or both components of the coordinates match, false otherwise 
	 */
	@Override
	...
	/**
	 * Creates a new coordinate with its components being the sum of the instance and the given coordinate
	 * 
	 * @param c The other coordinate, cannot be null
	 * 
	 * @return A new coordinate with its components being the sum of both coordinates
	 */
