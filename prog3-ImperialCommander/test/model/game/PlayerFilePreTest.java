...
public class PlayerFilePreTest {
	...
	/*
	 * Se crea un PlayerFile (en el setUp) y se comprueba que el GameShip que se
	 * crea es del bando REBEL y que el nombre es correcto. Además se comprueba que
	 * el objeto playerRandom es una instancia de IPlayer.
	 */
	@Test
	...
	/*
	 * Se prueba initFighters() para playerFile. Para ello se comprueba que el fleet
	 * del GameShip asociado tiene 42 cazas y que el ship es correcto (coincide con
	 * kREBELGAMESHIP)
	 */
	@Test
	...
	/*
	 * Crea un PlayerFile Imperial. Invoca a initFighters() y comprueba que el fleet
	 * del GameShip asociado tiene 535 cazas y que el ship es correcto (coincide con
	 * kIMPERIALGAMESHIP)
	 */
	// TODO
	@Test
...
//		fail("Realiza el test");
	 ...
	 * isFleetDestroyed es true. Tras iniciar la flota, se comprueba ahora que es
	 * false. Se destruyen todos y se comprueba que devuelve true.
	 */
	@Test
	...
	/*
	 * Se comprueba showShip para playerFile sin iniciarlo. Tras iniciarlo se
	 * comprueba que ahora coincide con kSHOWSHIP
	 */
	@Test
...
//		fail("Termina el test");
	...
	/*
	 * Inicia playerFile con cazas en su nave. Añadele un tablero. Invoca, para ese
	 * player, a nextPlay() una vez de tal forma que añada un caza en el tablero.
	 * Vuelve a invocar a nextPlay() para que lea exit y comprueba que devuelve
	 * false. Comprueba que está en el tablero en esa posición.
	 */
	// TODO
	@Test
	public void testNextPlay() {
		...
		assertTrue(gb.getFighter(new Coordinate(4, 6)) != null);
	 ...
	 * 
	 * Crea, para ese player, un String de órdenes de tal forma que: -añada 10
	 * AWing, 25 XWing y7 YWing al GameShip. -añade 3 cazas en el tablero (con cada
	 * una de las 3 posibilidades) y comprueba que así ha sido. -mejora uno de
	 * ellos. Comprueba que la mejora se ha efectuado. -pon a patrullar a uno en el
	 * tablero -abandona la partida Invoca, para ese player, a nextPlay() todas las
	 * veces necesarias para ejecutar todas las opciones
	 * 
	 */
	// TODO
	@Test
...
//		fail("Termina el ejercicio");
	...
	/*
	 * Tras iniciar playerFile con cazas y asignarles un tablero de 10x10, se invoca
	 * cinco veces a nextPlay() que debe ejecutar tres instrucciones improve
	 * erróneas: - con 1 número - con 3 números - con qty NO menor que 100 - con un
	 * id inexistente. - con una opción improve mal escrita: 'improves' Se comprueba
	 * que se emitieron los mensajes de error y que éstos empiezan con la subcadena
	 * "ERROR:".
	 */
	@Test
	...
	/*
	 * Tras iniciar playerFile con cazas y asignarles un tablero de 10x10, se invoca
	 * cinco veces a nextPlay() que debe ejecutar 6 instrucciones una launch
	 * correcta y 5 patrol erróneas: - con ningún número. - con 2 números - con un
	 * id que no está en el tablero. - con un id inexistente. - con una opción
	 * patrol mal escrita: 'patrols' Se comprueba que se emitieron los mensajes de
	 * error y que éstos empiezan con la subcadena "ERROR:".
	 */
	// TODO
	@Test
...
//		fail("Realiza el test");
	...
	private void errorsControl(String serr, int nlines) {
		...
		if (nlines != verr.length)
			fail("ERROR: Número de líneas de error incorrectas " + verr.length);
